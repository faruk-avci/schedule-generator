...
const Analytics = {
    ...
    Events: {
        ...
        CLICK_ELECTIVE_SECTION: 'CLICK_ELECTIVE_SECTION',
        CLICK_SCHEDULE_PREVIOUS: 'CLICK_SCHEDULE_PREVIOUS',
        CLICK_SCHEDULE_NEXT: 'CLICK_SCHEDULE_NEXT',
        MAINTENANCE_TOGGLE_LANG: 'MAINTENANCE_TOGGLE_LANG',
        MAINTENANCE_OPEN_BASKET: 'MAINTENANCE_OPEN_BASKET',
        MAINTENANCE_EXP_SAVED_BASKET: 'MAINTENANCE_EXP_SAVED_BASKET',
        MAINTENANCE_CLICK_SURVEY: 'MAINTENANCE_CLICK_SURVEY',
        MAINTENANCE_CLICK_SIS: 'MAINTENANCE_CLICK_SIS',
        MAINTENANCE_CLICK_CONTACT: 'MAINTENANCE_CLICK_CONTACT',
        MAINTENANCE_CLOSE_BASKET: 'MAINTENANCE_CLOSE_BASKET'
    },
